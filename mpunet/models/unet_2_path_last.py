...
class UNet_2_path(Model):
    ...
    def init_model(self):
        ...
        if self.n_classes == 1:
            out = Conv2D(self.n_classes, 1, activation='sigmoid', name=final_conv_origin_name)(bn)

        else:
            out = Conv2D(self.n_classes, 1, activation=self.out_activation, name=final_conv_origin_name)(bn)


        out_surface = Conv2D(1, 1, activation='sigmoid', name=final_conv_surf_name)(bn)
